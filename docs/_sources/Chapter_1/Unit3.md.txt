...
<mark >You may recall that the String class is included in the [Java language package (i.e. java.lang).] https://docs.oracle.com/javase/8/docs/api/java/lang/package-summary.html</mark> When you create a String object from its class, the object is a reference variable. For example, the following declarations create two String reference variables.
