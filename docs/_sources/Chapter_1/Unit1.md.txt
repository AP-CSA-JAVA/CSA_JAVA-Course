...
![Roller Coaster Key Functionalities](https://github.com/user-attachments/assets/5e02c085-c41f-4ab5-a17b-63a53ce3ce0f)
...
public class Main {
    public static void main(String[] args) {
        ...
        if (!sim.isSafe()) {
            // if G-force is too excessive print "TOO DANGEROUS!"
            // Recommend that the user make changes to height or curve
        } else {
            // print "Safe for riders!"
        }
...
Submit your `.java` program code and test cases that demonstrate your program works as intended.
